...
const ProjectEvaluation_Director = ({ navigation, route }) => {
    console.log(route.params);
    const [data, setData] = useState([]);
    const [isFetched, setIsFetched] = useState(true);
    useEffect(() => {
        setData([]);
        var InsertApiURL = `http://${ip}/EmpPerformanceApi/api/Teacher/getProjectQuestions`;
        fetch(InsertApiURL,
            {
                method: 'GET',
            }
...
export default ProjectEvaluation_Director;