...
const TeacherPerformace_Director1 = ({ navigation, route }) => {
                        ...
                        <View style={{ flex: 1 }}>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    return <View style={{ backgroundColor: '#038f7e', borderRadius: 10, marginBottom: 10, padding: 10, width: '95%', alignSelf: 'center', alignContent: 'center' }}>
...
export default TeacherPerformace_Director1;