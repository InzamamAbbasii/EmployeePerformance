...
import { StyleSheet, Text, View, TouchableOpacity, ToastAndroid, FlatList, ActivityIndicator } from "react-native";
...
const AdministrativeQuestions = ({ navigation, route }) => {
    ...
    const saveEvaluation = () => {
        data.forEach(element => {
            if (element.Selected !== '') {
                // console.log(route.params.EmpNo,element.Qid,element.Question,element.Category,element.Selected,route.params.empName,route.params.LoginId,);
        ...
        <View style={styles.container}>
            {
                isFetched == true ? (
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={{ fontSize: 24, fontWeight: 'bold', textAlign: 'center' }}> {route.params.empName} </Text>
...
export default AdministrativeQuestions;