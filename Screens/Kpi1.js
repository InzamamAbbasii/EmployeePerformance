...
const Kpi1 = ({ navigation, route }) => {
    ...
    const insertKPIWeightage = () => {
        ...
        var InsertApiURL = `http://${ip}/EmpPerformanceApi/api/Admin/addkpiweight2`;
        var headers = {
    ...
    const getSelectedKPIWeight = () => {
        setIsFetching(true);
        var InsertApiURL = `http://${ip}/EmpPerformanceApi/api/Admin/getSelectedKPIWeight2?staff=${selectedStaff}&category=${selectedCategory}&empno=${route.params.Id}`;
        fetch(InsertApiURL,
            {
                method: 'GET',
            }
