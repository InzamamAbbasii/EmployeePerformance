...
const AcademicQuestions = ({ navigation, route }) => {
    ...
    const saveEvaluation = () => {
        ...
        data.forEach(element => {
            if (element.Selected !== '') {
                console.log(route.params.EmpNo,element.Qid,element.Question,element.Category,route.params.CourseName,element.Selected,route.params.empName,route.params.LoginId);
